      ...
      <q-card flat bordered class="my-card">
        <q-card-section>
          ...
          <div class="text-subtitle1 q-mb-lg">
            Project information, AC unit details, and file uploads
          </div>
        </q-card-section>
        ...
        <q-card-section>
          <q-form @submit="onSubmit" class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              <q-input
                v-model="project.buildingSection"
                label="Section of Building"
                outlined
                dense
              />
            </div>
            ...
            <div class="col-12 q-mt-xl">
              <div class="row q-gutter-sm">
                ...
                <q-btn
                  label="Complete Asset Registration"
                  type="submit"
                  color="primary"
