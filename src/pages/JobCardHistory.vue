    ...
    <div class="row q-col-gutter-lg">
      <div class="col-12 flex justify-between items-center">
        <div>
          ...
          <div class="text-subtitle1 text-grey-7">Digital archive of all technical service and repair records</div>
        </div>
        ...
        <q-card flat bordered class="rounded-borders">
          ...
          >
            ...
            <template v-slot:top-right>
              <q-input borderless dense debounce="300" v-model="filter" placeholder="Search Job Cards...">
                <template v-slot:append>
                  <q-icon name="fas fa-magnifying-glass" size="xs" />
                </template>
              </q-input>
                  ...
                  <q-menu auto-close transition-show="scale" transition-hide="scale" class="rounded-borders shadow-2">
                    <q-list style="min-width: 150px">
                      ...
                      <q-item clickable @click="viewJobCard(props.row)">
                        <q-item-section avatar><q-icon name="fas fa-eye" color="grey-7" size="sm" /></q-item-section>
        ...
        <q-card-section class="q-pa-lg" v-if="selectedJobCard">
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="text-subtitle1 text-weight-bold text-primary">{{ selectedJobCard.unitRef }}</div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12">
              ...
              <q-chip 
                ...
                :icon="selectedJobCard.faultFound ? 'fas fa-triangle-exclamation' : 'fas fa-circle-check'"
            ...
            <div class="col-12">
              ...
              <div class="q-pa-md bg-grey-1 rounded-borders text-body2" style="min-height: 100px; white-space: pre-wrap;">
