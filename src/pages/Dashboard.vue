    ...
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12">
        ...
        <div class="text-subtitle1 text-grey-7">
          {{ welcomeMessage }} Here's what's happening today.
        </div>
      </div>
      ...
      <div class="col-6 col-md-2">
        <q-card class="hvac-gradient text-white shadow-5 hover-lift">
          <q-card-section>
            ...
            <q-icon
              name="fas fa-users-viewfinder"
              size="md"
              class="absolute-right q-ma-sm opacity-40"
            />
          </q-card-section>
        </q-card>
      </div>
          ...
          <q-list separator>
            <q-item v-for="service in todaysServices" :key="service.id" clickable v-ripple>
              <q-item-section avatar>
                <q-avatar
                  :style="{
                    backgroundColor: getTeamColor(service.teamId) + '20',
                    color: getTeamColor(service.teamId),
                  }"
                >
              ...
              <q-item-section side>
                <div class="column items-end">
                  <q-chip dense outline color="primary" icon="fas fa-clock" size="sm">
                    {{ service.time }}
                  </q-chip>
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      todaysServices: store.todaysServices,
      getTeamColor: store.getTeamColor,
    }
  },
})
</script>
