      ...
      <div class="col-12 flex justify-between items-center">
        <div>
          ...
          <div class="text-subtitle1 text-grey-7">
            Manage your global client base and contact records
          </div>
        </div>
          ...
          >
            ...
            <template v-slot:body-cell-projectsCount="props">
              <q-td :props="props" align="center">
                ...
                >
                  {{ props.row.projects?.length || 0 }} Project{{
                    (props.row.projects?.length || 0) !== 1 ? 's' : ''
                  }}
                ...
                <q-btn flat round color="grey-7" icon="fas fa-ellipsis-vertical">
                  ...
                  >
                    <q-list style="min-width: 150px">
                      <q-item
                        clickable
                        :to="{ path: '/projects', query: { customerId: props.row.id } }"
                      >
  ...
  setup() {
    ...
    const columns = [
      ...
      { name: 'mobile', label: 'Mobile', align: 'left', field: 'mobile', sortable: true },
      {
        ...
        label: 'Projects',
        align: 'center',
        field: (row) => row.projects?.length || 0,
        sortable: true,
      },
    ...
    const exportToExcel = () => {
      $q.notify({
        message: 'Exporting customer directory to Excel...',
        color: 'green-7',
        icon: 'file_download',
      })
