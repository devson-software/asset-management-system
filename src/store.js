...
export const store = reactive({
  ...
  jobCards: [
    ...
    },
    {
      ...
      quotationStatus: 'Awaiting Approval',
      signed: true,
      signedBy: 'technician',
    },
    {
  ...
  users: [
    {
      ...
      email: 'admin@jeramhvac.co.za',
      role: 'administrator',
      mobile: '+27 71 000 0000',
      accessLevel: 'primary',
      primaryDescription: 'Primary – full admin access to all functions and technician passwords.',
    ...
    },
    {
      ...
      username: 'tech1',
      fullName: 'John Doe',
      email: 'john@jeramhvac.co.za',
      role: 'technician',
      mobile: '+27 71 000 0001',
      accessLevel: 'secondary',
      primaryDescription: '',
      secondaryDescription: 'Secondary – field technician with access to job cards and service entry.',
      active: true,
      invitationStatus: 'Completed',
    },
    {
      ...
      email: 'sarah@jeramhvac.co.za',
      role: 'technician',
      mobile: '+27 71 000 0002',
      accessLevel: 'secondary',
      primaryDescription: '',
      secondaryDescription: 'Secondary – commissioning technician.',
      active: true,
    ...
    },
    {
      id: 'U4',
      username: 'tech3',
      fullName: 'Michael van Wyk',
      email: 'michael@jeramhvac.co.za',
      role: 'technician',
      mobile: '+27 71 000 0003',
      accessLevel: 'secondary',
      primaryDescription: '',
      secondaryDescription: '',
      active: true,
    ...
    },
    {
      ...
      email: 'david@jeramhvac.co.za',
      role: 'technician',
      mobile: '+27 71 000 0004',
      accessLevel: 'secondary',
      primaryDescription: '',
      secondaryDescription: '',
      active: true,
    ...
    },
    {
      ...
      email: 'kevin@jeramhvac.co.za',
      role: 'technician',
      mobile: '+27 71 000 0005',
      accessLevel: 'tertiary',
      primaryDescription: '',
      secondaryDescription: 'Tertiary – team member with no admin access.',
      active: true,
      invitationStatus: 'Pending',
    },
    {
      ...
      fullName: 'Alpha Corp Manager',
      email: 'manager@alphacorp.com',
      role: 'customer',
      mobile: '+27 71 000 0006',
      accessLevel: 'tertiary',
      primaryDescription: '',
      secondaryDescription: 'Customer contact – portal access only.',
      active: true,
      invitationStatus: 'Completed',
    },
  ],
