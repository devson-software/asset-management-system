          ...
          <q-form @submit="onSubmit" class="q-gutter-y-lg">
            ...
            <div class="section-container">
              <div class="text-subtitle1 text-weight-bold text-primary q-mb-md row items-center">
                <q-icon name="fas fa-circle-info" size="xs" class="q-mr-sm" /> Asset / Project
                Information
              </div>
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  ...
                  >
                    <template v-slot:prepend
                      ><q-icon name="fas fa-diagram-project" size="xs"
                    /></template>
                  </q-input>
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="col-12 col-md-6">
                  ...
                  >
                    <template v-slot:prepend
                      ><q-icon name="fas fa-calendar-day" size="xs"
                    /></template>
                  </q-input>
                </div>
              </div>
            ...
            <div class="section-container">
              ...
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-md-4">
                  <q-input
                    v-model="form.elec.measuredAmps"
                    label="Measured Amps"
                    outlined
                    dense
                    bg-color="white"
            ...
            <div class="section-container" v-if="type === 'Pump'">
              <div class="text-subtitle1 text-weight-bold text-primary q-mb-md row items-center">
                <q-icon name="fas fa-faucet-drip" size="xs" class="q-mr-sm" /> Hydraulic /
                Performance Measurements
              </div>
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.suction"
                    label="Suction Pressure (kPa / bar)"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.discharge"
                    label="Discharge Pressure (kPa / bar)"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.flowRate"
                    label="Calculated Flow Rate (L/s)"
                    outlined
                    dense
                    bg-color="white"
                  />
            ...
            <div class="section-container" v-if="type === 'Fan'">
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.airflow"
                    label="Measured Airflow (L/s)"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.staticPressure"
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.fanSpeed"
                    label="Fan Speed (RPM or %)"
                    outlined
                    dense
                    bg-color="white"
                  />
            ...
            <div class="section-container" v-if="type === 'DX Split'">
              <div class="text-subtitle1 text-weight-bold text-primary q-mb-md row items-center">
                <q-icon name="fas fa-snowflake" size="xs" class="q-mr-sm" /> Refrigeration / Airside
                Performance
              </div>
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.returnAir"
                    label="Return Air Temp (Off Coil) °C"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.supplyAir"
                    label="Supply Air Temp (On Coil) °C"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.suctionLine"
                    label="Suction Line Temp °C"
                    outlined
                    dense
                    bg-color="white"
                  />
                ...
                <div class="col-12 col-md-6">
                  <q-input
                    v-model="form.perf.liquidLine"
                    label="Liquid Line Temp °C"
                    outlined
                    dense
                    bg-color="white"
                  />
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12 col-md-6">
                  <q-input
                    ...
                    label="Commissioned By (Engineer)"
                    outlined
                    dense
                    bg-color="white"
                  >
                ...
                <div class="col-12 col-md-6">
                  <q-input v-model="form.witness" label="Witness" outlined dense bg-color="white">
                    <template v-slot:prepend
                      ><q-icon name="fas fa-user-check" size="xs"
                    /></template>
                  </q-input>
                </div>
                <div class="col-12">
                  <q-input
                    ...
                    label="Outstanding Issues / Comments"
                    type="textarea"
                    outlined
                    dense
                    bg-color="white"
            ...
            <div class="row q-gutter-md justify-between q-mt-xl">
              ...
              <q-btn
                :label="isEdit ? 'Update Report' : 'Finalize & Submit Report'"
                color="primary"
                type="submit"
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerIcon = computed(() => {
      if (type.value === 'Pump') return 'fas fa-water'
      if (type.value === 'Fan') return 'fas fa-wind'
      return 'fas fa-box'
    })
    ...
    const onSubmit = () => {
      ...
      if (isEdit) {
        ...
        $q.notify({
          color: 'positive',
          message: 'Commissioning report updated',
          icon: 'check_circle',
        })
      } else {
        ...
        $q.notify({
          color: 'positive',
          message: 'Commissioning report finalized and uploaded',
          icon: 'check_circle',
        })
      }
